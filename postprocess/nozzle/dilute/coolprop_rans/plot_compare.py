...
fig1.savefig("nozzle_di_cr_gv_p.pdf")

# fig 2
fig2 = plt.figure( dpi=300)
lwh = 2
axes = fig2.add_axes([0.15, 0.15, 0.7, 0.7]) #size of figure
axes.plot(m0.iloc[:,4]*1000 , m0.iloc[:,0], 'k', lw=lwh, label="n=4k")
axes.plot(m1.iloc[:,4]*1000 , m1.iloc[:,0], 'r', lw=lwh, label="n=11k")
axes.plot(m2.iloc[:,4]*1000 , m2.iloc[:,0], 'g', lw=lwh, label="n=19k")
...
# axes.set_ylim(0.2,1)
#axes.legend(loc=2) # 2 means left top
fig2.savefig("nozzle_di_cr_gv_m.pdf")
