...
axes.plot(mesh1.iloc[:,-3] , mesh1.iloc[:,6]/Pc, 'r', lw=lwh, label="9k")
...
axes.plot(mesh1.iloc[:,-3] , mesh1.iloc[:,2], 'r', lw=lwh, label="9k")
...
axes.plot(mesh1.iloc[:,-3] , mesh1.iloc[:,0]/dc, 'r', lw=lwh, label="9k")
...
axes.plot(m1new.iloc[:,-5] , m1new.iloc[:,-1], 'r', lw=lwh, label="9k")
...
# axes.plot(m1new.iloc[:,-5] , m1new.iloc[:,-1], 'r', lw=lwh, label="9k")
# axes.plot(m3new.iloc[:,-5] , m3new.iloc[:,-1], 'g', lw=lwh, label="18k")
axes.plot(m4s.iloc[:,-5] , m4s.iloc[:,-1], 'b', lw=lwh, label="30k")
