...
m2new = pd.read_csv("m2new.csv", ",", skiprows=0)
m3new = pd.read_csv("m3new.csv", ",", skiprows=0)
m4new = pd.read_csv("prnew.csv", ",", skiprows=0)
...
axes.plot(mesh3.iloc[:,-3] , mesh3.iloc[:,6]/Pc, 'k', lw=lwh, label="5k")
...
axes.plot(mesh3.iloc[:,-3] , mesh3.iloc[:,0]/dc, 'k', lw=lwh, label="5k")
axes.plot(mesh4.iloc[:,-3] , mesh4.iloc[:,0]/dc, 'r', lw=lwh, label="12k")
axes.plot(mesh5.iloc[:,-3] , mesh5.iloc[:,0]/dc, 'g', lw=lwh, label="18k")
axes.plot(mesh6.iloc[:,-3] , mesh6.iloc[:,0]/dc, 'b', lw=lwh, label="30k")
